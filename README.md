...
13. **Integration（push / GHA）:** `./scripts/test-integration.sh`（片系: `./scripts/generator/test-integration.sh`、`./scripts/playback/test-integration.sh`）。generator gate は secret なし Narrow のみ。残作業 index は `docs/tasks/todo/generator-lane.md`
