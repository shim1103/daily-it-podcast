...
1. [ ] 運用後続 — rollback 文書化、Workers Logs（`observability`）、DAST（保留）、CD/hook 自動 deploy（非 scope）、Dependabot/Renovate（低）
2. [ ] `docs/tasks/todo/playback-web-view-models.md`
3. [ ] `docs/tasks/todo/playback-web-ui-rewrite.md`
4. [ ] `docs/tasks/todo/playback-web-legacy-cleanup.md`
