...
監視 user 一括取得 UseCase（`FetchWatchedPosts`）を Application 層に追加し、Fake `PostSource` 付き sociable unit test を通した。Issue2 draft todo を削除し generator-lane を更新した。skill 準拠の reviewer 査読と GWT 復元を経て commit・push した。
