...
func newHackerNewsItemSource(httpClient *http.Client, maxItems int, logw *delivery.LogWriter) port.ItemSource {
	return hackernews.NewListItemSource(httpClient, maxItems, logw)
}
