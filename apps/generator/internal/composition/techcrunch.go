...
func newTechCrunchItemSource(httpClient *http.Client, maxItems int, logw *delivery.LogWriter) port.ItemSource {
	return techcrunch.NewListItemSource(httpClient, maxItems, logw)
}
