...
func newCloudWatchItemSource(httpClient *http.Client, maxItems int, logw *delivery.LogWriter) port.ItemSource {
	return cloudwatch.NewListItemSource(httpClient, maxItems, logw)
}
