	...
	return []models.SourceItem{
		{
			...
			Summary:    "コンテナ基盤の大型アップデート",
			Detail: models.SourceBody{Text: "あるクラウド事業者が、マネージド型のコンテナ実行基盤に大型アップデートを発表した。" +
		...
		},
		{
			...
			Summary:    "Web フレームワークのメジャー候補版",
			Detail: models.SourceBody{Text: "広く使われているオープンソースの Web フレームワークが、メジャーバージョンの候補版を公開した。" +
		...
		},
		{
			...
			Summary:    "エッジ向け推論アクセラレータ",
			Detail: models.SourceBody{Text: "ある半導体メーカーが、エッジ機器向けの推論アクセラレータの新モデルを公表した。" +
		...
		},
		{
			...
			Summary:    "PR レビュー支援の拡充",
			Detail: models.SourceBody{Text: "あるコード管理サービスが、プルリクエストのレビュー支援機能を拡充した。" +
		...
		},
		{
			...
			Summary:    "オフライン再同期の仕様案",
			Detail: models.SourceBody{Text: "複数のブラウザベンダーが参加する標準化団体が、Web アプリのオフライン動作に関する新しい仕様案を公開した。" +
