...
| `8ff4177b-26fe-4036-ab7b-d2a4e9e7639d.wav` | 上記 `durationSec`（518.56 秒）と一致する合成音声。**配置契約は `.mp3`（`contracts/episode-layout.md`）。物理 file の mp3 差し替えは `docs/tasks/todo/audio-mp3-cutover-migrate.md`**。 |
...
配置契約: `contracts/episode-layout.md`
