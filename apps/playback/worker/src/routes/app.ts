...
import { ValidationError, listEpisodesPath } from "../../../contracts/index.ts";
...
app.get(listEpisodesPath, async (c) => {
...
app.get(`${listEpisodesPath}/:episodeId`, async (c) => {
...
app.get(`${listEpisodesPath}/:episodeId/audio`, async (c) => {
